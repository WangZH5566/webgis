    ...
    $.fn.spinner = function (opts) {
        return this.each(function () {
            ...
            var defaults = {
                ...
                max:(max==null||max=="")?null:max,
                maxlength:(maxlength==null||maxlength=="")?2:maxlength
            };
            ...
            function isInvalid(value) {
                return isNaN(+value) || (options.min!=null&&value < options.min) || (options.max!=null&&value > options.max); }
