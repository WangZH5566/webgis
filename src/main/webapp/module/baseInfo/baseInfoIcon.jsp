...
<body>
            ...
            <div class="col-md-8">
                <div class="widget-box">
                    <div class="widget-title">
                        ...
                        <a href="javascript:;" id="btn_save" class="btn btn-xs btn-primary buttons">保存</a>
                    </div>
                    <div class="widget-content clearfix" style="min-height: 536px;text-align: center;">
                        <div style="text-align: center;" id="div_list"></div>
                        <div id="div_page_btn" style="top: 530px;position: absolute;left: 35px;"></div>
                    </div>
                </div>
            </div>
            <input type="hidden" id="txt_base_info_type" value="${ti}">
        </div>
    </div>
    ...
    <script src="${ctx}/js/module/baseInfo/baseInfo.js?v=20161028004"></script>
    <script type="text/javascript">
        var setting={
            ...
            callback: {
                onClick: WEBGIS.baseInfoIcon.zTreeOnClick
            }
        };
        WEBGIS.baseInfoIcon.init();
    </script>
</body>
</html>