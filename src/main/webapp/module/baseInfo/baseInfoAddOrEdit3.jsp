            ...
            <div class="widget-box">
                ...
                <div class="widget-content no-padding" style="height: 460px;overflow-y:auto;">
                    <table class="table table-bordered">
                        ...
                        <tbody id="tbody_equipment_list">
                        <c:forEach var="item" items="${equipmentDtos}" varStatus="st">
                            <tr>
                                <td style="width:30px;text-align: center;"><input type="checkbox" data-id="${item.id}" <c:if test="${not empty eqMap[item.id]}">checked</c:if> ></td>
                                <td>${item.infoCode}</td>
