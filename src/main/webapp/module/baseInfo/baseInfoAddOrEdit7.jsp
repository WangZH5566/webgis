                    ...
                    <form class="form-horizontal" action="#" method="post" novalidate="novalidate" id="form_search">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-3 control-label form-label2">专业:</label>
                                <div class="col-sm-8 form-div2">
                                    <select class="form-control no-blank" id="sel_major" data-na="专业">
                                        <option value=""></option>
                                        <c:forEach items="${baseInfoMajorDtos}" var="item">
                                            <option value="${item.id}" <c:if test="${item.id eq dto.majorId}">selected</c:if>>${item.majorName}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-3 control-label form-label2">数量:</label>
                                <div class="col-sm-8 form-div2">
                                    <input type="text" placeholder="" class="form-control" id="txt_count" value="${dto.count}" data-na="数量"/>
                                </div>
                            </div>
                        </div>
